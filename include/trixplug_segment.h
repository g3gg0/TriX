...
struct segment_funcs
{
	...
	t_segment *(*find_by_end) ( t_segment * s, unsigned int addr);
	t_segment *(*find_by_name) ( t_segment * s, char *name);
	t_segment *(*find_by_num) ( t_segment * s, unsigned int num);
	t_segment *(*find_by_start) ( t_segment * s, unsigned int addr);
	...
	unsigned int (*release_all) ( t_segment * s);
 	t_segment *(*find_by_end_and_name) ( t_segment * s, unsigned int addr, char *name);
};

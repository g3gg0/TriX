...
t_segment *segment_find_by_end_and_name ( t_segment * s, unsigned int addr, char *name );
t_segment *segment_find_by_end ( t_segment * s, unsigned int addr );
t_segment *segment_find_by_start ( t_segment * s, unsigned int addr );
t_segment *segment_find_by_name ( t_segment * s, char *name );

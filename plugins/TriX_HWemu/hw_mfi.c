#ifndef __TRIX_HW_MFI_C__
#define __TRIX_HW_MFI_C__
...
unsigned int hwemu_mfi_handle ( t_workspace *ws, unsigned int address, unsigned char type, unsigned int value )
{
	int okay = 0;
	int read = 1;
	int write = 0;
	unsigned int data = 0;
	unsigned char *sect = "MFI";
	unsigned char *desc = "";
	unsigned int offset = address - MFI_BASE;

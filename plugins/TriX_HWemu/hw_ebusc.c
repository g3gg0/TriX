#ifndef __TRIX_HW_EBUSC_C__
#define __TRIX_HW_EBUSC_C__
...
unsigned int hwemu_ebusc_handle ( t_workspace *ws, unsigned int address, unsigned char type, unsigned int value )
{
	int okay = 0;
	int read = 1;
	int write = 0;
	unsigned int data = 0;
	unsigned char *sect = "EBUSC";
	unsigned char *desc = "";
	unsigned int offset = address - EBUSC_BASE;
